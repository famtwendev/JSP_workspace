...
public class KhachHangDAO implements DAOInterface<KhachHang> {
		...
		try {
			...
			while (rs.next()) {
				...
				ketQua = new KhachHang(maKhacHang, tenDangNhap, matKhau, hoVaTen, gioiTinh, diaChi, diaChiNhanHang,
						diaChiMuaHang, ngaySinh, soDienThoai, email, dangKyNhanBangTin,maXacThuc,hieuLucMaXacThuc,trangThaiXacThuc);
			}
	...
	public int updateVerifyInformation(KhachHang t) {
		...
		try {
			...
			// Bước 2: tạo ra đối tượng statement
			String sql = "UPDATE khachhang " + " SET " + " maxacthuc=?" + ", hieulucmaxacthuc=?" + ", trangthaixacthuc=?" +  " WHERE makhachhang=?";
			PreparedStatement st = con.prepareStatement(sql);
	...
	public KhachHang selectByUserAndPassWord(KhachHang t) {
		...
		try {
			...
			/*			
			  // Test SQL Injection			  
			  Statement st = (Statement)con.createStatement(); String sql =
			  "SELECT * FROM khachhang WHERE tendangnhap='"+t.getTenDangNhap()
			  +"' and matkhau='" +t.getMatKhau()+"'"; 
			  // Bước 3: thực thi câu lệnh SQL
...
/*
	public static void main(String[] args) {
		String maKhachHang = "1711714303499";
...
//		khachHang.setTenDangNhap("hihihaha");
//		khachHang.setMatKhau("1234");
//		khachHang.setHoVaTen("Nguyễn Văn Rỗi");
//		khachHang.setDangKyNhanBangTin(false);
//		
//		khd.insert(khachHang);
//		kh = khd.selectAll();
//		for(KhachHang khh : kh)
//		{
//			System.out.println(khh);
