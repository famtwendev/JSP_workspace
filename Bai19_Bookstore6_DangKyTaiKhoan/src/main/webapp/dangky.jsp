		...
		<form id="myForm" class="form needs-validation" action="dang-ky" method="post">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="mb-3">
						<label for="tenDangNhap" class="form-label">Tên đăng nhập<span class="red">*	<%=e_tenDangNhap %> <%=e_tenDangNhapFormat %></span></label>
				...
				<div class="col-md-6">
					...
					<div class="mb-3">
						<label for="email" class="form-label">Email<span class="red">*	<%=e_email %>.	<%=e_emailFormat%></span></label>
					...
					<div class="mb-3">
						...
						<input type="checkbox" class="form-check-input" id="dongYNhanEmail"
							name="dongYNhanEmail"
							<%=(dongYNhanEmail.equals("1")) ? "checked" : ""%>>
					</div>
