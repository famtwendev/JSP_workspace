...
<body>
	...
	%>
	<section class="vh-100" style="background-image: url(<%=url%>/img/background.jpg);">
		<%
					...
					<div class="card" style="border-radius: 1rem;">
						...
						<div class="row g-0">
							...
							<div class="col-md-6 col-lg-5 d-none d-md-block">
								<img src="<%=url%>/img/mountain.jpg" alt="login form" class="img-fluid"
								...
								<div class="card-body p-4 p-lg-4 text-black">
									...
									<form  action="<%=url%>/khach-hang" method="POST">
										...
										<div data-mdb-input-init class="form-outline mb-4">
											<input type="text" id="tenDangNhap" class="form-control form-control-lg"
												name="tenDangNhap" />
											<label class="form-label" for="tenDangNhap"> <i class="fas fa-user"></i>
												Tên đăng nhập
											</label>
										</div>

										<div class="form-outline mb-4" data-mdb-input-init>
											<input type="password" id="matKhau" class="form-control form-control-lg"
												name="matKhau" />
											<label class="form-label" for="matKhau"> <i class="fas fa-key"></i> Mật
												khẩu
											</label>
										...
										<div class="d-flex justify-content-around align-items-center mb-4">
											...
											<a class="text-end" href="<%=url%>/KhachHang/checkemail.jsp">Quên mật khẩu?</a>
										</div>
