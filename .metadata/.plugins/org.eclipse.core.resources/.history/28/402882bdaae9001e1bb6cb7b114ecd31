		...
		<nav class="navbar navbar-expand-lg navbar-light bg-body-tertiary">
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<!-- Navbar brand -->
					<a class="navbar-brand mt-2 mt-lg-0" href="./KhachHang/dangky.jsp">
				...
				<div class="d-flex align-items-center">
					...
					<a data-mdb-ripple-init class="btn btn-link border border-primary px-3 me-2"
						style="white-space: nowrap;" href="./KhachHang/dangnhap.jsp">Đăng nhập</a>
					<a data-mdb-ripple-init class="btn btn-primary me-3" style="white-space: nowrap;"
						href="./KhachHang/dangky.jsp">Đăng ký</a>
					<%
					} else {
					%>
					<!-- Icon -->
					...
					<div class="dropdown px-2">
						...
						<ul class="dropdown-menu dropdown-menu-end"
							...
							<li><a class="dropdown-item" href="./KhachHang/thaydoithongtinKH.jsp">Thay đổi thông
									tin</a></li>
